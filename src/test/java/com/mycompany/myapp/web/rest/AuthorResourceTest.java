...
public class AuthorResourceTest {
    ...
    public void initTest() {
        ...
        author.setSummary(DEFAULT_SUMMARY);
    ...
    public void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getSummary()).isEqualTo(DEFAULT_SUMMARY);
    ...
    public void updateAuthor() throws Exception {
        ...
        author.setSummary(UPDATED_SUMMARY);
        ...
        assertThat(testAuthor.getSummary()).isEqualTo(UPDATED_SUMMARY);
