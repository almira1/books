...
booksApp.factory('Register', function ($resource) {
        return $resource('app/rest/register', {}, {
        });
    });

booksApp.factory('Activate', function ($resource) {
        return $resource('app/rest/activate', {}, {
            'get': { method: 'GET', params: {}, isArray: false}
        });
    });

booksApp.factory('Account', function ($resource) {
        return $resource('app/rest/account', {}, {
        });
    });

booksApp.factory('Password', function ($resource) {
        return $resource('app/rest/account/change_password', {}, {
        });
    });

booksApp.factory('Sessions', function ($resource) {
        return $resource('app/rest/account/sessions/:series', {}, {
            'get': { method: 'GET', isArray: true}
        });
    });

booksApp.factory('MetricsService',function ($http) {
    		return {
            get: function() {
...
booksApp.factory('ThreadDumpService', function ($http) {
        return {
            dump: function() {
...
booksApp.factory('HealthCheckService', function ($rootScope, $http) {
        return {
            check: function() {
...
booksApp.factory('ConfigurationService', function ($rootScope, $filter, $http) {
    return {
        get: function() {
...
booksApp.factory('LogsService', function ($resource) {
...
booksApp.factory('AuditsService', function ($http) {
        return {
            findAll: function() {
...
booksApp.factory('Session', function () {
...
booksApp.factory('AuthenticationSharedService', function ($rootScope, $http, authService, Session, Account) {
        return {
